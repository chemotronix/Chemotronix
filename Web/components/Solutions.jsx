  ...
  return (
    <div>
      <div className="flex flex-wrap items-center justify-center mb-10">
        <h2 className="text-2xl text-[#000000] lg:text-4xl max-w-xs uppercase">
          Our Innovative Solutions
        </h2>
      </div>
      <div className="flex flex-wrap mb-10">
        <div className="flex flex-wrap justify-evenly w-full">
          <div className="w-1/3 border-2 border-solid border-green-500 rounded-xl px-8 py-10 max-w-xs ">
          ...
          <div className="w-1/3 border-2 border-solid border-green-500 px-8 py-10 rounded-xl max-w-xs ">
